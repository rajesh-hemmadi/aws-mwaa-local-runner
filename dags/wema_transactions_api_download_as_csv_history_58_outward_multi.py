...
HISTORY_START_DATE_TIME_CSV = '20230101 00.csv'
HISTORY_END_DATE_TIME_CSV = '20230430 23.csv'
...
with DAG(dag_id="wema_transactions_api_download_as_csv_history_58_outward_multi",
         description="wema_transactions_api_download_as_csv_history_58_outward_multi",
