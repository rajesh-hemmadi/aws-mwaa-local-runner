    ...
    try:
        ...
        for index, row in file_metadata_df.iterrows():
            ...
            for item in items:
                ...
                #v_is_file_processed = return_first_cell_data_from_redshift_stored_procedure(schema_name=REDSHIFT_SCHEMA, sp_name='s3_process_check_if_file_processed', params={
