...
def load_csv_file_to_redshift(**kwargs):
    try:
        ...
        load_process_reference_id = return_first_cell_data_from_redshift_stored_procedure(schema_name='gdrive_ingestions', sp_name='gdrive_process_get_load_reference_id', params={
